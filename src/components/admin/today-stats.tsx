...
// Pedido do cliente: nada de dinheiro (faturamento/ticket médio) na tela do
// Kanban, que fica visível pra qualquer pessoa perto do balcão — só
// contagens, sem valor nenhum.
